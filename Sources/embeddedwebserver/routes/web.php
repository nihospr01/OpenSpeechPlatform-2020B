...
/** Calibration **/
Route::get('/calibration', 'CalibrationController@index');
Route::post('/calibration', 'CalibrationController@store');
Route::put('/calibration', 'CalibrationController@update');
Route::get('/calibration/default', 'CalibrationController@getDefault');
Route::post('/calibration/default', 'CalibrationController@setDefault');