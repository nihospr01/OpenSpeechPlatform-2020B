...
-- Module  Version: 5.7
--/usr/local/diamond/3.10_x64/ispfpga/bin/lin64/scuba -w -n pll_8 -lang vhdl -synth synplify -arch xo3c00f -type pll -fin 12.288 -fclkop 98.304 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -rst -fb_mode 1 

-- Wed Jul 11 19:13:04 2018
...
architecture Structure of pll_8 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "98.304000";
...
-- synopsys translate_off
library MACHXO3L;
configuration Structure_CON of pll_8 is
    for Structure
